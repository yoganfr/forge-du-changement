...
### Distinction Responsable / Décideur / Pilote

Ces trois notions sont **complémentaires**, pas redondantes. Elles répondent à 3 questions différentes sur le jalon :

**Responsable** (personne physique)

- *Qui porte l'atteinte du jalon sur le terrain, opérationnellement ?*
- Le plus souvent un **manager N-1 ou N-2** que le membre CODIR désigne
- C'est cette personne qui déclinera le jalon en **Plan d'Action d'Équipe** dans le futur module PAE (actions concrètes, ressources, planning détaillé)
- **Exemple** : « Sarah Lachaux, Responsable Qualité » pour un jalon « Les procédures HACCP ont été déployées »

**Décideur** (personne physique)

- *Qui valide formellement que le jalon est atteint ?*
- Typiquement le **membre CODIR owner de la roadmap** — mais peut être délégué à un pair du CODIR pour éviter le conflit « je me valide moi-même » sur certains jalons sensibles
- **Exemple** : « Directeur Général » pour valider un jalon stratégique, ou « Directeur Qualité » si délégation explicite

**Pilote** (direction organisationnelle, pas une personne)

- *Quelle direction porte la ligne d'axe dans le RACI macro ?*
- C'est la **direction fonctionnelle ou géographique** responsable de l'axe dans le chantier (ex. : DSI pilote l'axe Outils, DRH pilote l'axe Organisation RH)
- **Peut être différente** de la direction du Responsable si le jalon est co-porté (ex. : un manager RH est Responsable d'un jalon dont le Pilote RACI est la DSI parce que le jalon relève du système RH)
- **Exemple** : « Direction des Systèmes d'Information » pour un jalon « Le CRM a été déployé »

**En résumé** :

- **Responsable** = manager terrain N-1/N-2 (futur rédacteur du PAE)
- **Décideur** = membre CODIR qui valide (owner de la roadmap ou délégué)
- **Pilote** = direction organisationnelle portant la ligne (RACI macro)
